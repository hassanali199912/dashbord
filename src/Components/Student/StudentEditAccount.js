export default function StudentEditAccount() {
    return <><div className="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page" style={{"padding-top":"60px"}}>
        ...
        <div className="row no-gutters">
          ...
          <div className="col-lg-8 card-form__body card-body">
            ...
            <div className="form-group">
              ...
              <textarea id="desc" rows={4} className="form-control" placeholder="Bio / description ..." defaultValue={""} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <label htmlFor="subscribe">Subscribe to newsletter</label><br />
              <div className="custom-control custom-checkbox-toggle custom-control-inline mr-1">
                <input defaultChecked type="checkbox" id="subscribe" className="custom-control-input" />
                <label className="custom-control-label" htmlFor="subscribe">Yes</label>
              </div>
              <label htmlFor="subscribe" className="mb-0">Yes</label>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <input id="opass" type="password" className="form-control" placeholder="Old password" defaultValue="****" />
                </div>
                <div className="form-group">
      ...
      <div className="card card-form">
        <div className="row no-gutters">
          <div className="col-lg-4 card-body">
            ...
            <p className="text-muted mb-0">Update your public profile with relevant and meaningful information.</p>
          </div>
          <div className="col-lg-8 card-form__body card-body">
            <div className="form-group">
              <label>Avatar</label>
              <div className="dz-clickable media align-items-center" data-toggle="dropzone" data-dropzone-url="http://" data-dropzone-clickable=".dz-clickable" data-dropzone-files="[&quot;assets/images/account-add-photo.svg&quot;]">
                <div className="dz-preview dz-file-preview dz-clickable mr-3">
                  <div className="avatar avatar-lg">
                    <img src="assets/images/account-add-photo.svg" className="avatar-img rounded" alt="..." data-dz-thumbnail />
                  </div>
                </div>
            ...
            <div className="form-group">
              ...
              <textarea id="desc2" rows={4} className="form-control" placeholder="Description ..." defaultValue={""} />
            </div>
            <div className="form-group">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="input-group input-group-merge mb-2">
                    <input id="social1" type="text" className="form-control form-control-prepended" placeholder="Facebook" />
                    <div className="input-group-prepend">
                      <div className="input-group-text">
                        <span className="fab fa-facebook text-facebook" />
                      </div>
                    </div>
                  </div>
                  <div className="input-group input-group-merge mb-2">
                    <input id="social2" type="text" className="form-control form-control-prepended" placeholder="Twitter" />
                    <div className="input-group-prepend">
                      <div className="input-group-text">
                        <span className="fab fa-twitter text-twitter" />
                      </div>
                    </div>
                  </div>
                  <div className="input-group input-group-merge mb-2">
                    <input id="social3" type="text" className="form-control form-control-prepended" placeholder="Instagram" />
                    <div className="input-group-prepend">
                      <div className="input-group-text">
                        <span className="fab fa-instagram text-instagram" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="form-group">
              <label htmlFor="customCheck1">Available for freelance?</label>
              <div className="custom-control custom-checkbox">
                <input type="checkbox" className="custom-control-input" id="customCheck1" defaultChecked />
                <label className="custom-control-label" htmlFor="customCheck1">Yes, show me as available for freelance!</label>
              </div>
            </div>
          </div>
        </div>
