...
useEffect(()=>{
 ...
 document.querySelectorAll('.sidebar .sidebar-menu-item')[props.index].classList.add('active');
  ...
  return (
    <>
     <div className="mdk-drawer  js-mdk-drawer  " id="default-drawer" data-align="start">
      <div className="mdk-drawer__content">
        <div
          className="sidebar sidebar-dark sidebar-left bg-dark-gray"
        >
          <div className="d-flex align-items-center sidebar-p-a sidebar-account flex-shrink-0">
            <Link
              to='/'
            ...
            >
              ...
              <span className="flex d-flex flex-column">
                <span className="sidebar-brand">Edusta</span>
          ...
          <ul className="sidebar-menu">
            <li className="sidebar-menu-item ">
              <Link className="sidebar-menu-button" to={'/'}>
                ...
                <span className="sidebar-menu-text">Overview</span>
              </Link>
            </li>
          </ul>
          ...
          <div className="sidebar-block p-0">
            <ul className="sidebar-menu mt-0">
              ...
              <li className="sidebar-menu-item">
                <Link
                className="sidebar-menu-button"
                  to={'StudentCoursePurchase'}
                >
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    shopping_cart
                  </i>
                  <span className="sidebar-menu-text">Purchase Course</span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'StudentLessons'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    dns
                  </i>
                  <span className="sidebar-menu-text">Browse Lessons</span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'StudentQuiz'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    live_help
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'StudentEditAccount'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    settings
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'StudentBilling'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    monetization_on
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" >
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    exit_to_app
                  </i>
          ...
          <div className="sidebar-block p-0">
            <ul className="sidebar-menu mt-0">
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'AuthorDashbord'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    dvr
                  </i>
                  <span className="sidebar-menu-text">Dashboard</span>
                  <span className="badge badge-warning rounded-circle badge-notifications ml-auto">
                    8
                  </span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'AuthorCourses'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    layers
                  </i>
                  <span className="sidebar-menu-text">Courses</span>
              ...
              <li className="sidebar-menu-item">
                <Link
                  className="sidebar-menu-button"
                 to={'AuthorQuizManager'}
                >
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    assignment
                  </i>
                  <span className="sidebar-menu-text">Quiz Manager</span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'AuthorEarning'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    local_atm
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'AuthorReports'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    pie_chart
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" to={'AuthorPayout'}>
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    credit_card
                  </i>
          ...
          <div className="sidebar-block p-0">
            <ul className="sidebar-menu mt-0">
              ...
              {/* <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" href="admin-emails.html">
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    email
                  </i>
                  <span className="sidebar-menu-text">Emails</span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" href="admin-chat.html">
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    comment
                  </i>
              ...
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" href="admin-tickets.html">
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    local_offer
                  </i>
                  <span className="sidebar-menu-text">Tickets</span>
                  <span className="badge badge-warning badge-notifications ml-auto">
                    NEW
                  </span>
                </Link>
              </li>
              <li className="sidebar-menu-item">
                <Link className="sidebar-menu-button" href="admin-trello.html">
                  <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                    touch_app
                  </i>
