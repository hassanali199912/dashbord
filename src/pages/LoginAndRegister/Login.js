export default function Login(){
  ...
  <div className="d-flex flex-column justify-content-center align-items-center mt-2 mb-2 navbar-light">
    <a href="index.html" className="navbar-brand text-center mb-2 mr-0" style={{"min-width":"0"}}>
      ...
      <span className="ml-2">Educate</span>
    </a>
  </div>
  <div className="card card-body">
    ...
    <form action="index.html" noValidate>
      <div className="form-group">
        <label className="text-label" htmlFor="email_2">Email Address:</label>
      ...
      <div className="form-group">
        <label className="text-label" htmlFor="password_2">Password:</label>
        <div className="input-group input-group-merge">
      ...
      <div className="form-group text-center">
        <div className="custom-control custom-checkbox">
          <input type="checkbox" className="custom-control-input" defaultChecked id="remember" />
          <label className="custom-control-label" htmlFor="remember">Remember me for 30 days</label>
        </div>
      </div>
      <div className="form-group text-center">
        <a href>Forgot password?</a> <br />
        Don't have an account? <a className="text-body text-underline" href="signup.html">Sign up!</a>
      </div>
    </form>
  </div>
        </div>
